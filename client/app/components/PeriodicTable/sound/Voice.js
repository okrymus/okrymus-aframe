...
import BufferSource from "tone/Tone/source/BufferSource";
import AudioBuffers from "tone/Tone/core/Buffers";
...
export class Voice extends events.EventEmitter {
  constructor() {
    ...
    this._players.add("experience", url(`${voFolder}/intro.[mp3|ogg]`));
    this._players.add("loading", url(`${voFolder}/loading.[mp3|ogg]`));
